...
def TransitionBasedParser_v1(
    ...
    if use_upper:
        ...
        upper = None
    return TransitionModel_v1(tok2vec, lower, upper, resize_output=resize_output_v1)
...
def TransitionBasedParser_v2(
    ...
    * upper (optional): A feed-forward network that predicts scores from the
    ...
    return TransitionModel_v1(tok2vec, lower, upper, resize_output_v2)
...
def resize_output_v2(model, new_nO):
